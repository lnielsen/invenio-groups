...
class SubscriptionPolicyTestCase(BaseTestCase):
    ...
    def test_validate(self):
        ...
        from invenio.modules.groups.models import SubscriptionPolicy
...
class PrivacyPolicyTestCase(BaseTestCase):
    ...
    def test_validate(self):
        """Test policy validation."""
        from invenio.modules.groups.models import PrivacyPolicy
...
class MembershipState(BaseTestCase):
    ...
    def test_validate(self):
        """Test policy validation."""
        from invenio.modules.groups.models import MembershipState

        self.assertTrue(MembershipState.validate(MembershipState.PENDING_ADMIN))
        self.assertTrue(MembershipState.validate(MembershipState.PENDING_USER))
...
class GroupTestCase(BaseTestCase):
    ...
    def test_update(self):
        """."""
        from invenio.modules.groups.models import Group, SubscriptionPolicy, \
            PrivacyPolicy
