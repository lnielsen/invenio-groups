...
class Group(db.Model):
        ...
        info=dict(
            ...
            description=dict([
                ...
                (SubscriptionPolicy.APPROVAL,
                 _('Users can self-subscribe but requires'
    ...
    def add_member(self, user, state=MembershipState.ACTIVE):
        ...
        :param user: User to be added as a member.
...
class Membership(db.Model):
    ...
    def query_requests(cls, admin, eager=False):
        ...
        q1 = GroupAdmin.query_by_admin(admin).with_entities(GroupAdmin.group_id)
...
class GroupAdmin(db.Model):
    ...
    def delete(cls, group, admin):
        ...
        """
        try:
            obj = cls.query.filter(cls.admin == admin, cls.group == group).one()
